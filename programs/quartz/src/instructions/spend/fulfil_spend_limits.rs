...
fn get_order_data<'info>(
    ...
    let next_timeframe_reset_timestamp = ctx.accounts.spend_limits_order.next_timeframe_reset_timestamp;
    ...
    Ok((spend_limit_per_transaction, spend_limit_per_timeframe, timeframe_in_seconds, next_timeframe_reset_timestamp))
}